...
class DomainRecord(object):
    def __init__(self,original_domain):
        ...
        self.cnames, self.cnames_ttl, self.ips, self.ips_ttl, self.ns, self.ns_ttl,self.ips_geo = [], [], [], [], [], [],[]
    ...
    def return_domain_rc(self):
        ...
        """
        rc_ttl = {}
        rc_ttl['ns'], rc_ttl['ns_ttl'], rc_ttl['cnames'], rc_ttl['cnames_ttl'], rc_ttl['ips'], rc_ttl['ips_ttl'], rc_ttl['ips_geo'] =self.ns, self.ns_ttl, self.cnames,self.cnames_ttl,self.ips,self.ips_ttl,self.ips_geo
        return rc_ttl
...
if __name__ == '__main__':
    print manage_rc_ttl('www.01d8.com')